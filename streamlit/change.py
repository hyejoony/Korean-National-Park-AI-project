...
# 과거 데이터 표시
    ...
    # 가장 가까운 날짜 (Sentinel-1)을 표시해야 하는지 여부 확인
    display_nearest_date_s1 = any(past_data[key] for key in ['VH', 'VV'])

    if display_nearest_date_s1:
