...
# 과거 평균확인 코드
def get_dynamic_world_data2(aoi, date):
    nearest_date = find_nearest_date(aoi, date, 'GOOGLE/DYNAMICWORLD/V1')
...
def process_user_input(lat, lon, variables):
    ...
    if nearest_date_vh is None or nearest_date_dw is None:
        ...
        period_built_mean, period_crops_mean, period_water_mean, period_trees_mean, period_grass_mean, period_bare_mean = get_dynamic_world_data2(aoi, current_date)
